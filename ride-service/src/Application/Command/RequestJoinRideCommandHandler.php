...
final class RequestJoinRideCommandHandler extends CommandHandler
{
    ...
    /**
     * @param RequestJoinRideCommand $command
     * @throws AccessDeniedException
     * @throws InvalidUuidException
     */
    protected function handle(RequestJoinRideCommand $command): void
    {
